<div class='container div-principal'>
        ...
        <form class = "container text-center" method="POST" action="<?=URL?>/usuarios/cadastrar">
            ...
            <div class="form-floating">
                <input type="password" value = "<?=$dados['confirmar_senha']?>" name = "confirmar_senha" class="form-control <?=$dados['erro']['confirmar_senha']?'is-invalid':''?>" id="floatingPassword" placeholder="Password">
