...
--
-- Host: 127.0.0.1
-- Tempo de geração: 29-Jun-2022 às 17:49
...
(15, 14, 'mhjSSS', 'AAA1234', '2022-06-29 15:27:14');
...
(4, 2009, 'Corumba', 11, 11),
(7, 2022, 'SaoFrancisco', 11, 11);
...
(14, 'Alvaro', 'alvaro@gmail.com', 'fa916f02ddb45f4ab01d3c48eabe8799', '2022-06-29 15:26:04');
...
--
ALTER TABLE `tb_carro`
  MODIFY `idtb_carro` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;

--
-- AUTO_INCREMENT de tabela `tb_infracao`
--
ALTER TABLE `tb_infracao`
  MODIFY `idtb_infracao` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de tabela `tb_multa`
--
ALTER TABLE `tb_multa`
  MODIFY `idtb_multa` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de tabela `tb_usuario`
--
ALTER TABLE `tb_usuario`
  MODIFY `idtb_usuario` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;
COMMIT;
